...
const Footer = () => {
  ...
  const handleSubscribe = (e: { preventDefault: () => void; }) => {
    e.preventDefault();
    // You can add your logic here to handle the subscription, e.g., sending data to a backend server.
      ...
      <div className="grid grid-cols-2 gap-8 px-4 py-6 lg:py-8 md:grid-cols-4">
        ...
        <div>
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
                <li className="my-11">
                    <a href="#" className="">Le meilleur choix pour votre prochaine
acquisition</a>
                </li>
        ...
        <div>
            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Inscrivez-vous pour recevoir les dernières nouvelles</h2>
            <ul className="text-gray-500 dark:text-gray-400 font-medium">
    ...
    <div className=" px-4 py-6 text-[#ffffff] bg-[#005BAF] md:flex md:items-center md:justify-between">
        <span className="text-center text-sm sm:text-center">© 2023 <a href="">Company's name</a>. All Rights Reserved.
        </span>
